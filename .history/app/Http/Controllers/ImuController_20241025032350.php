...
class ImuController extends Controller
{
    ...
    public function index(Request $request) {
        try {
            ...
            Event::dispatch(new ImuDataUpdated($imus));
    ...
    public function update(Request $request, string $id)
    {
        try {
            ...
            return redirect()->route('imus.index')->with('success', 'IMU record updated successfully!');
    ...
    public function destroy(Request $request, string $id)
    {
        try {
            ...
            return redirect()->route('imus.index')->with('success', 'IMU record deleted successfully!');
